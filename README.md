...
RepoGovernance is a project I'm building to help monitor all of my side-projects and ensure they are following best practices, with repo settings, branching, actions, dependabot, etc. It uses a number of building blocks I've built in the past:
