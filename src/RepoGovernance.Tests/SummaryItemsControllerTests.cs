    ...
    public void GetSummaryItemsTest()
    {
        ...
        if (item1 != null)
        {
            ...
            if (item1.SonarCloud != null)
            {
                ...
                Assert.AreEqual("https://sonarcloud.io/project/issues?resolved=false&types=BUGS&id=samsmithnz_AzurePipelinesToGitHubActionsConverter", item1.SonarCloud.CodeSmellsLink);
